...
// TODO Registrieren der "handlebars-layouts" Helpers nicht mehr möglich mit Assemble Version > 17.0.0
engine.Handlebars.registerHelper(require('template-helpers')());
require('handlebars-layouts').register(assemble.engine('hbs').Handlebars);
